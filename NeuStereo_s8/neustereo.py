...
from NeuStereo_s8 import backbone
from NeuStereo_s8 import transformer
from NeuStereo_s8 import matching
from NeuStereo_s8 import corr
from NeuStereo_s8 import refine
from NeuStereo_s8 import upsample
import pdb
...
class NeuStereo(torch.nn.Module):
    def __init__(self, config):
        ...
        self.cross_attn_s8 = transformer.FeatureAttention(self.config.feature_dim_s16+self.config.context_dim_s16, num_layers=2, ffn=True, ffn_dim_expansion=1, post_norm=True)
    ...
    def forward(self, img0, img1, iters_s16=1, iters_s8=8):
        ...
        flow0 = self.matching_s8.global_correlation_softmax(feature0_s8, feature1_s8)
